            ...
            <div class="d-flex flex-row-fluid flex-column justify-content-between">
                ...
                <div class="d-flex flex-column-fluid flex-column flex-center mt-5 mt-lg-0">
                    ...
                    <div class="login-form login-signin">
                        ...
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" id="kt_login_signin_form" action="/signin" method="post">
                    ...
                    <div class="login-form login-signup">
                        ...
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" id="kt_login_signup_form" action="/signup" method="post">
                            <div class="form-group py-3 m-0">
                                <input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="text" placeholder="Full name" name="fullName" autocomplete="off" />
                            </div>
                            <div class="form-group py-3 border-top m-0">
                            ...
                            <div class="form-group py-3 border-top m-0">
                                <input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="password" placeholder="Confirm password" name="passwordConfirm" autocomplete="off" />
                            </div>
                    ...
                    <div class="login-form login-forgot">
                        ...
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" id="kt_login_forgot_form" action="/forget" method="post">
                ...
                <div class="d-flex flex-column-auto justify-content-between mt-15">
                    <div class="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">© 2021 Vietnamese Social</div>
        ...
        <div class="order-1 order-lg-2 flex-column-auto flex-lg-row-fluid d-flex flex-column p-7" style="background-image: url(assets/media/bg/bg-4.jpg);">
            ...
            <div class="d-flex flex-column-fluid flex-lg-center">
                <div class="d-flex flex-column justify-content-center">
                    <h3 class="display-3 font-weight-bold my-7 text-white">Welcome to Our community!</h3>
                    <p class="font-weight-bold font-size-lg text-white opacity-80">The Vietnamese social network
                        <br />Help us build a better world</p>
                </div>
            </div>
            <!--end::Content body-->
        </div>
