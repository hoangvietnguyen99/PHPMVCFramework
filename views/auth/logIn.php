                ...
                <div class="login-form">
                    ...
                    <form class="form" id="kt_login_singin_form" action="/login" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control h-auto py-7 px-6 rounded-lg border-0" type="email" name="{{name}}" value="{{value}}"/>',
                            'email')
                            ?>
                        </div>
                        <!--end::Form group-->
                        ...
                        <div class="form-group">
                            <?PHP
                            echo new Field($model, '<div class="d-flex justify-content-between mt-n5">
                                <label class="font-size-h6 font-weight-bolder text-dark pt-5">{{label}}</label>
                                <a href="/forgot"
