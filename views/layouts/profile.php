                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?php echo $user->fullName ?></a>
                                    <div class="text-muted"><?PHP if ($user->isAdmin): ?>Administrator<?PHP else: ?>User<?PHP endif; ?></div>
                                    <div class="mt-2">
                            ...
                            <div class="py-9">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="mailto: <?php echo $user->email ?>" class="text-muted text-hover-primary"><?php echo $user->email ?></a>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <span class="font-weight-bold mr-2">Join date:</span>
                                    <span class="text-muted"><?php echo $user->joinDate->format('r') ?></span>
                                </div>
                            </div>
                            <!--end::Contact-->
                            <!--begin::Nav-->
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="/profile/account-information" class="navi-link py-4">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
