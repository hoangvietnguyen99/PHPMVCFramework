                                    ...
                                    <div class="d-flex align-items-center justify-content-between mr-5">
                                        <a href="#"
                                           class="btn btn-hover-text-primary btn-hover-icon-primary btn-sm btn-text-dark-50 bg-hover-light-primary rounded font-weight-bolder font-size-sm p-2">
																<span class="svg-icon svg-icon-md svg-icon-dark-25 pr-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo9\dist/../src/media/svg/icons\Navigation\Angle-double-up.svg--><svg
...
</svg><!--end::Svg Icon--></span>24</a>
                                        <a href="#"
                                           class="btn btn-hover-icon-danger btn-hover-text-danger bg-hover-light-danger btn-sm btn-text-dark-50 rounded font-weight-bolder font-size-sm p-2">
																<span class="svg-icon svg-icon-md svg-icon-dark-25 pr-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo9\dist/../src/media/svg/icons\Navigation\Angle-double-down.svg--><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1">
...
</svg><!--end::Svg Icon--></span>15</a>
                                        <a href="#"
                                           class="btn btn-hover-text-success btn-hover-icon-success bg-hover-light-success btn-sm btn-text-dark-50 rounded font-weight-bolder font-size-sm p-2">
                                        ...
                                        <div class="d-flex align-items-center flex-grow-1">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <a href="/questions?id=1"
                                                   class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-boldest">How to connect to MongoDb by PHP How to connect to MongoDb by PHP</a>
                                                <span class="text-muted font-weight-bolder">CSS, PHP, MONGODB, CSS, PHP, MONGODB</span>
                                            </div>
                                            <!--end::Info-->
                                            <div class="d-flex flex-column align-items-end ml-2">
                                                <a href="/users?id=1"
                                                   class="text-dark-75 text-hover-success mb-1 font-size-lg font-weight-bolder">User Name</a>
                                                <span class="text-muted font-weight-bold">asked 1 hour ago</span>
                                            </div>
                                            <!--begin::Symbol-->
