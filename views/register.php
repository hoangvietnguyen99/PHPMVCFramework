...
<div class="login-signup">
    ...
    <form class="form text-left" id="kt_login_signup_form" method="post">
        ...
        <div class="form-group d-flex flex-wrap flex-center">
            <button id="kt_login_signup_submit" class="btn btn-primary btn-pill font-weight-bold px-9 py-4 my-3 mx-2">
                Submit
            </button>
            <a href="/signin" class="btn btn-outline-primary btn-pill font-weight-bold px-9 py-4 my-3 mx-2">Already have
                an account?</a>
        </div>
    </form>
</div>
